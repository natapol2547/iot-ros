#!/usr/bin/env python3
"""Generate docs/wiring/04-nucleo.svg: Nucleo-F401RE to ultrasonics and battery sense.
...
def main():
    ...
    text(420, 950, 'HC-SR04P LEFT', 'h', 'middle')
    ...
    for x, lab in ((1070, 'VCC'), (1130, 'TRIG'), (1190, 'ECHO'), (1250, 'GND')):
        add(f'<rect x="{x - 6}" y="894" width="12" height="12" fill="#ffffff" stroke="#333" '
            'stroke-width="1.5"/>')
        text(x, 922, lab, 'xs b', 'middle')
    text(1160, 950, 'HC-SR04P RIGHT', 'h', 'middle')
    ...
    notes_left = [
        ...
        'the Nucleo.',
        '',
        'ECHO high equals VCC, 5 V',
        'here. Divider order: Nucleo',
        'pin, node with 2 kΩ to GND,',
        '1 kΩ, ECHO. The pin sees',
        '3.33 V. These pins are 5 V',
        'tolerant in digital mode;',
        'the divider keeps margin.',
        '',
    ...
    notes_right = [
        ...
        'sees 3.33 V.',
        '',
        'Alternative: 3.3 V supply',
        'VCC from +3V3 (CN6-4), ECHO',
        'straight to the pin: remove',
        'both 2 kΩ; each 1 kΩ may',
        'stay as series protection.',
        'No divider to build, but the',
        'range drops a little (sellers',
        'quote 4.5 m at 5 V, 4.0 m at',
